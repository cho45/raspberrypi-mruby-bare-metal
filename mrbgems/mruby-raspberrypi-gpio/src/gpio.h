...
#define ARM_INTERRUPT_BASE               BUS_ADDRESS(0x7E00B000)
#define ARM_INTERRUPT_IRQ_BASIC_PENDING  ( ARM_INTERRUPT_BASE+0x200 )
#define ARM_INTERRUPT_IRQ_PENDING_1      ( ARM_INTERRUPT_BASE+0x204 )
#define ARM_INTERRUPT_IRQ_PENDING_2      ( ARM_INTERRUPT_BASE+0x208 )
#define ARM_INTERRUPT_FIQ_CONTROL        ( ARM_INTERRUPT_BASE+0x20C )
#define ARM_INTERRUPT_ENABLE_IRQS_1      ( ARM_INTERRUPT_BASE+0x210 )
#define ARM_INTERRUPT_ENABLE_IRQS_2      ( ARM_INTERRUPT_BASE+0x214 )
#define ARM_INTERRUPT_ENABLE_BASIC_IRQS  ( ARM_INTERRUPT_BASE+0x218 )
#define ARM_INTERRUPT_DISABLE_IRQS_1     ( ARM_INTERRUPT_BASE+0x21C )
#define ARM_INTERRUPT_DISABLE_IRQS_2     ( ARM_INTERRUPT_BASE+0x220 )
#define ARM_INTERRUPT_DISABLE_BASIC_IRQS ( ARM_INTERRUPT_BASE+0x224 )
